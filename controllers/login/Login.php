...
class Login extends MY_Controller {
	...
	public function process()
	{
		...
		{   
			...
			$this->session->set_userdata('user_frontoffice_utama',$user);
			...
			redirect( site_url('Frontoffice/frontoffice_index') ); 
			}
	...
	public function logout()
		{
			$this->session->unset_userdata('user_frontoffice_utama');
