    ...
    <div class="container position-relative text-center text-lg-left" data-aos="zoom-in" data-aos-delay="100">
      <div class="row">
        <div class="col-lg-8">
          ...
          <h3>Akun Tamu <?php echo $this->config->item('nama_opd'); ?><h3>
          ...
          <div class="btns">
            ...
            <a href="#" class="btn-book animated fadeInUp scrollto" data-toggle="modal" data-target="#loginModal2">Login Tamu <?php echo $this->config->item('nama_opd'); ?></a>
          </div>
        </div>
        ...
        <div class="modal-body">
          <form action="<?php echo site_url('login/logintamupegawai/process') ?>" method="post" accept-charset="utf-8">
            <div class="form-group">
              <div align="center"><label for="username">Akun Tamu <?php echo $this->config->item('nama_opd'); ?></label></div>
