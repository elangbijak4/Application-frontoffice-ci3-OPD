    ...
    <div class="container position-relative text-center text-lg-left" data-aos="zoom-in" data-aos-delay="100">
      <div class="row">
        <div class="col-lg-8">
          ...
          <h3>Akun Pegawai <?php echo $this->config->item('nama_opd'); ?><h3>
          <h2><?php echo $this->config->item('nama_bidang'); ?></h2>

          <div class="btns">
            <a href="#" class="btn-menu animated fadeInUp scrollto" data-toggle="modal" data-target="#loginModal">Register</a>
            <a href="#about" class="btn-menu animated fadeInUp scrollto">Tentang Kami</a>
            <a href="#" class="btn-menu animated fadeInUp scrollto" data-toggle="modal" data-target="#loginModal2">Login Pegawai <?php echo $this->config->item('nama_opd'); ?></a>
          </div>
        </div>
        ...
        <div class="modal-body">
          <form action="<?php echo site_url('login/logintamupegawai/process_pegawai') ?>" method="post" accept-charset="utf-8">
            <div class="form-group">
              <div align="center"><label for="username">Akun Pegawai <?php echo $this->config->item('nama_opd'); ?></label></div>
              <div class="input-group mb-3">
                <div class="input-group-prepend">
                  <span class="input-group-text" style='color:black;'><i class="icofont-user-suited"></i></span>
                </div>
                <input type="text" class="form-control" id="username" placeholder="NIP baru sebagai username" name="username" required>
              </div>
            </div>
            <div class="form-group">
