...
<head>
    <title>Frontoffice e-Office <?php echo $this->config->item('nama_opd'); ?> Provinsi Sulawesi Selatan</title>
    <!-- Meta-Tags -->
	...
	<div class="layer">
		...
		<div class="content-w3ls">
			<div class="text-center icon">
				<span class="text-login" style="font-size:35px;">Login Front Office <?php echo $this->config->item('nama_opd'); ?></span>
			</div>
			<div class="content-bottom">
				<form action="<?php echo site_url('login/login/process') ?>" method="post" accept-charset="utf-8">
					...
					<div class="wthree-field">
						<button type="submit" class="btn">Masuk Front Office</button>
					</div>
					<ul class="list-login">
