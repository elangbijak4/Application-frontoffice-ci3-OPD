...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
  ...
  <title>Akun Pribadi Pegawai dan Tamu</title>
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo site_url('Frontoffice/frontoffice_admin'); ?>">
        ...
        <div class="sidebar-brand-text mx-3"><font size="1.5pt">Akun Pegawai dan Tamu</font></div>
      </a>
      ...
      <li class="nav-item">
        <a class="nav-link" href="">
          ...
          <span>Dashboard <?php echo ucwords($user['username']); ?></span></a>
      </li>
      ...
      <script>      
          $(document).ready(function(){
            $("#ubah_password").click(function(){
              ...
              tampilkan.hide();
              loading.fadeIn(); 
              $.post('<?php echo site_url("/Akuntamupegawai/ubah_password_tamu/".$user['username']);?>',{ data: "ok bro"},
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?php echo strtoupper($user['username']);?></span>
        ...
        <div class="container-fluid">
          ...
          $(document).ready(function(){
            $("#profil_saya").click(function(){
              ...
              tampilkan.hide();
              loading.fadeIn(); 
              $.post('<?php echo site_url("/Akuntamupegawai/tampilkan_profil_tamupegawai/".$user['username']);?>',{ data:"okbro"},
              function(data,status){
                loading.fadeOut();
                tampilkan.html(data);
                tampilkan.fadeIn(2000);
          ...
          $(document).ready(function(){
            $("#kelola_profil").click(function(){
              ...
              tampilkan.hide();
              loading.fadeIn(); 
              $.post('<?php echo site_url("/Akuntamupegawai/gerbang/rincian_penampil_kelola_profil");?>',{ data: "<?php echo $user['username']; ?>"},
              function(data,status){
                loading.fadeOut();
                tampilkan.html(data);
                tampilkan.fadeIn(2000);
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content" <?php echo $this->config->item('style_modal_admin');?>>
        ...
        <div class="modal-footer">
          ...
          <a class="btn btn-primary" href="<?php echo base_url('index.php/login/logintamupegawai/logout') ?>">Logout</a>
        </div>
      </div>
    </div>
  </div>
