...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
  ...
  <title>Admin Dashboard Front Office</title>
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo site_url('Frontoffice/frontoffice_admin'); ?>">
        ...
        <div class="sidebar-brand-text mx-3"><font size="1.5pt">Admin Front Office</font></div>
      </a>
      ...
      <a class="nav-link" onclick='$("#cetak_laporan").show();$("#cetak_laporan_periodik_agenda").hide();' href="<?php echo site_url('Frontoffice/frontoffice_admin'); ?>">
          ...
          <span>Dashboard Front Office</span></a>
      </li>
      ...
      <div class="modal fade" id="myModal_suratbaru" role="dialog" ><!--//xx8-->
        ...
        <div class="modal-content" <?php echo $this->config->item('style_modal_admin');?>>
          ...
          <h4 class="modal-title">e-Sinra <?php echo $this->config->item('nama_opd');?> Prov. Sulsel</h4>
      ...
      <script>      
      $(document).ready(function(){
        $("#surat_masuk_internal").click(function(){
          var loading = $("#pra_tabel");
          var tampilkan = $("#penampil_tabel");
          tampilkan.hide();
          loading.fadeIn(); 
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <?php foreach ($tables as $key=>$table) { 
              if($table!=='surat_masuk' && $table!=='surat_keluar' && $table!=='surat_balasan_tamupegawai' && $table!=='surat_masuk_bidang' && $table!=='surat_terusan'){
              ?>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <img class="img-profile rounded-circle" src="../../login/p1.png" alt="">
              </a>
