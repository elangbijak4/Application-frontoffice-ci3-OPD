...
<html>
	<head>
		<title>e-Sinra Front Office <?php echo $this->config->item('nama_opd');?> Prov. Sulawesi Selatan</title>
		<meta charset="utf-8" />
	...
	<body class="landing">
		...
		<!-- Header -->
			<header id="header" class="alt">
				<a style="float:left;margin-left:5px;">e-Sinra Front Office <?php echo $this->config->item('nama_opd');?> Prov. Sulsel</a>
				<a href="#nav">Menu</a>
			</header>
		...
		<!-- Footer -->
			<footer id="footer">
				<div class="inner">
					...
					<ul class="copyright">
						<li>&copy; e-Sinra <?php echo $this->config->item('nama_opd');?> Provinsi Sulawesi Selatan.</li>
						<li>Design: <a href="http://templated.co">templated.co</a>.</li>
					</ul>
				</div>
			</footer>
...
<div class="modal fade" id="myModal" role="dialog" style="z-index:100000;">
	...
	<div class="modal-header">
		...
		<img src="<?php echo base_url('/public/restaurantly/assets/img/LogoSulselH.png');?>" class="logo_sulsel" style="float:left;margin-right:20px;height:50px;width:140px;" />
		e-Sinra <?php echo $this->config->item('nama_opd'); ?> Prov. Sulsel</h2>
...
<div class="modal fade" id="myModal1" role="dialog" style="z-index:100000;">
	...
	<!-- Modal content-->
		...
		<div class="modal-header">
			...
			<img src="<?php echo base_url('/public/restaurantly/assets/img/LogoSulselH.png');?>" class="logo_sulsel" style="float:left;margin-right:20px;height:50px;width:140px;" />
			<br><br>e-Sinra <?php echo $this->config->item('nama_opd'); ?> Prov. Sulsel</h4>
		<!--<button type="button" class="close" data-dismiss="modal">&times;</button>-->
		</div>
		<div class="modal-body">
		<center>
