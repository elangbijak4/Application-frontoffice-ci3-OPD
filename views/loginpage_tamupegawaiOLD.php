...
<head>
    <title>Akun Tamu e-Office <?php echo $this->config->item('nama_opd'); ?> Provinsi Sulawesi Selatan</title>
    <!-- Meta-Tags -->
...
<section class="main">
	<div class="layer">
		...
		<div class="bottom-grid">
			<div class="logo">
				<h1> <img src="<?php echo base_url('/assets/images/logo_sulsel.png');?>" class="logo_sulsel" style="float:left;margin-right:10px;" /><a href="#">e-Office <?php echo $this->config->item('nama_opd'); ?> Prov. Sulsel</a></h1>
			</div>
			<div class="links" >
		...
		<div class="content-w3ls">
			<div class="text-center icon">
				<span class="text-login" style="font-size:25px;">Login Akun Tamu <?php echo $this->config->item('nama_opd'); ?></span>
			</div>
			<div class="content-bottom">
				<form action="<?php echo site_url('login/logintamupegawai/process') ?>" method="post" accept-charset="utf-8">
		...
		<div class="bottom-grid1">
			...
			<div class="copyright" style="font-size:10px;">
				<p><a href="#">© 2020 <?php echo $this->config->item('nama_opd'); ?> Prov. Sulsel | Design:</a>
