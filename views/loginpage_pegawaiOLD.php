...
<head>
    <title>Akun Pegawai e-Office <?php echo $this->config->item('nama_opd'); ?> Provinsi Sulawesi Selatan</title>
    <!-- Meta-Tags -->
	...
	<div class="layer">
		...
		<div class="content-w3ls">
			<div class="text-center icon">
				<span class="text-login" style="font-size:25px;">Login Akun Pegawai <?php echo $this->config->item('nama_opd'); ?></span>
			</div>
